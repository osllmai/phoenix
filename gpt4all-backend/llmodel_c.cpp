...
{
    LLModelWrapper *wrapper = reinterpret_cast<LLModelWrapper*>(gptj); // ./chat -m "D:\C_QT\ggml-gpt4all-j.bin" -t 4
...
llmodel_model llmodel_model_create(const char *model_path) {
    ...
    if (magic == 0x67676d6c) { model = llmodel_gptj_create();  } // //./chat -m "D:\C_QT\ggml-gpt4all-j.bin" -t 4
