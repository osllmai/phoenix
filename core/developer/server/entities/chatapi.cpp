...
ChatAPI::ChatAPI(const QString &email, const QString &firstName, const QString &lastName,
...
bool ChatAPI::update(const QJsonObject &json)
{
...
void ChatAPI::updateFields(const QJsonObject &json)
{
...
QJsonObject ChatAPI::toJson() const
{
...
void ChatAPI::updateTimestamp() { updatedAt = QDateTime::currentDateTimeUtc(); }
